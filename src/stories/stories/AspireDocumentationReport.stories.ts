//AspireDocumentationReport.stories.ts
//Component for documentation reports
...
const meta = {
  ...
  component: AspireDocumentationReport,
  tags: ["autodocs"],
  argTypes: {},
} satisfies Meta<AspireDocumentationReport>;

export default meta;
type Story = StoryObj<AspireDocumentationReport>;
    ...
    allEvents: [
      {
        ...
        fallDetails: {
          objList: [
            {
              Answer: ".",
              CreatedAt: "2024-02-23T15:29:59.297000Z",
              CreatedBy: "Smith, Brandy",
              Question: "Assistive device utilized by resident:",
            },
            {
              Answer: ".",
              CreatedAt: "2024-02-23T15:29:59.310000Z",
              CreatedBy: "Smith, Brandy",
            ...
            },
            {
              ...
              CreatedAt: "2024-02-23T15:29:59.310000Z",
              CreatedBy: "Smith, Brandy",
              Question: "Clinical Summary/Root Cause Analysis:",
            },
            {
              Answer: "*Not provided*",
              CreatedAt: "2024-02-23T15:29:59.310000Z",
      ...
      },
      {
        ...
        fallDetails: {
          objList: [
            {
              Answer: "Cane",
              CreatedAt: "2023-03-07T13:53:59.297000Z",
              CreatedBy: "Smith, Brandy",
              Question: "Assistive device utilized by resident:",
            },
            {
      ...
      },
      {
        ...
        fallDetails: {
          objList: [
            {
              Answer: "Walker",
              CreatedAt: "2023-11-08T13:53:59.297000Z",
              CreatedBy: "Smith, Brandy",
              Question: "Assistive device utilized by resident:",
            },
            {
      ...
      },
      {
        ...
        fallDetails: {
          objList: [
            {
              Answer: "Walker",
              CreatedAt: "2024-01-17T13:53:59.297000Z",
              CreatedBy: "Smith, Brandy",
              Question: "Assistive device utilized by resident:",
            },
            {
