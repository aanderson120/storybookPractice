//AspireResidentBox.stories.ts
//Story for AspireResidentBox component
...
const meta = {
  title: "Resident Box",
  component: AspireResidentBox,
  tags: ["autodocs"],
} satisfies Meta<AspireResidentBox>;

export default meta;
type Story = StoryObj<AspireResidentBox>;
