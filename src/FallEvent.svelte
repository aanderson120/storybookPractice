<script>
  ...
  let allCustomers = [{ displayVal: "" }];
  let allCampuses = [{ displayVal: "" }];
      ...
      <fieldset class="md:mr-[366px]">
        ...
        <AspireRow className="justify-between">
                    ...
                    <div class="float-right">
                      ...
                      <span class="buttonTooltip"
                        ...
                        <div class="tooltiptext -left-44">
                          <p>
                            Mild: minor cut scrape or abrasion requiring minimal
                            oversight.
                          </p>
                          <p>
          ...
          <AspireCard size="md:w-[48%]">
            ...
            {#if selectedEvent.fallDetails.Vitals && (selectedEvent.fallDetails.Vitals.Temp || selectedEvent.fallDetails.Vitals["Blood Pressure"] || selectedEvent.fallDetails.Vitals.Pulse || selectedEvent.fallDetails.Vitals.Respiration)}
              ...
              <AspireHeader label={"Vitals From RTasks"} />
              <div class="form-group">
                ...
                {#if selectedEvent.fallDetails.Vitals.Respiration}
                  <h5 class="text-lg font-light mb-2">
                    Respiration: {selectedEvent.fallDetails.Vitals.Respiration}
                  </h5>
                {/if}
              ...
              <AspireFormQuestion
                question="Do you want to use these vitals?"
                value="selectedEvent.useImportedVitals"
                label="useVitals"
              />
            {/if}
            <br />
            ...
            <div class="form-row flex">
              <AspireTextInput
                bind:value={selectedEvent.eventO2}
                placeholder={"MAHC 10 Score"}
                id={"MAHC10Score"}
                size="20"
              />
              <AspireDatePicker
                bind:value={selectedEvent.MAHC10Date}
                id={"MAHC10ScoreDate"}
                label={"MAHC10 Score Date"}
                size="20"
              />
              <AspireTextInput
                bind:value={selectedEvent.SLUMs}
                placeholder={"SLUMS/MMSE Score"}
                id={"SLUMSScore"}
                size="20"
              />
              <AspireDatePicker
                bind:value={selectedEvent.SLUMsDate}
                id={"SLUMSScoreDate"}
        ...
        <AspireCard>
          ...
          <AspireFormQuestion
            ...
            bind:value={selectedEvent.fallDetails.Arrhythmia}
          />
